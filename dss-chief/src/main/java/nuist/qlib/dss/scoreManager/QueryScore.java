...
import nuist.qlib.dss.dao.QueryScoreDao;
...
public class QueryScore {
	...
	public List<HashMap<String, Object>> getPrintRank(String matchName,
			String category, int matchType) {
		List<HashMap<String, Object>> data = dao.getPrintRank(matchName,
				category, matchType);
		int i = 1;
		HashMap one = null;
		String score = "";
	...
	public boolean exportScoreExcel(List<HashMap<String, Object>> data,
		...
		return excelManager.ExportScoreExcel(data, fileName, matchName,
				category, matchType);
	}
